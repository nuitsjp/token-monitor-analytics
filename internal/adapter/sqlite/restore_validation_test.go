...
func insertIrreproducibleRestoreResult(t *testing.T, path string) {
	...
	execRestoreMutation(t, path, `
		...
		VALUES ('result', 'result-key', 'service', 'definition', 'weekly', '["interval"]', '2026-01-01T00:00:00Z', '2026-01-08T00:00:00Z', 'estimated', '[]', '[100]', 1, 0, 1, 0, 'logic-v1', 'matching-v1', 'not-reproducible', '2026-08-26T00:00:00Z', '2026-08-26T00:00:00Z');`)
}
