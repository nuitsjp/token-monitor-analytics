...
| ID | タスク | 依存 | 成果物・受入れ |
| --- | --- | --- | --- |
| T-040 | T01 と M01 の運用表示 | T-002、T-012、T-023、T-033 | T01、初回チェックリスト、収集・要確認・推定状態、最近増加した利用枠、Go DTO の `remainingPercent`・鮮度状態、一元状態マッパー、全表示経路のプライバシーマスク。未実装機能の空カードを表示しない |
...
| --- | --- | --- |
| SCREEN-COMMON | 3、5、8、9 の Phase 1 共通規則、および `design-system.md` 2–9 | T-002、T-050 |
